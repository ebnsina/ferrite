...
/// Result alias used throughout `verve-av`.
...
pub enum AvError {
    ...
    /// This build of `verve-av` was compiled without the `ffmpeg` feature.
    #[error("verve-av was built without the `ffmpeg` feature; rebuild with --features ffmpeg")]
    NotBuiltWithFfmpeg,
